...
import { PaymentView } from '../client/ClientPayment'
...
const PaymentScreen = () => {
    ...
    const onCheckStatus = async (paymentResponse) => {
        ...
        try {
            ...
            const stripeResponse = await axios.post('https://taskify-backend-server.onrender.com/payment', {
                email: 'manthanthakkar02@gmail.com',
                product: cartInfo,
