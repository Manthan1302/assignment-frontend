...
import { UserIcon, UserGroupIcon ,ArrowUpOnSquareStackIcon
  ,CurrencyRupeeIcon,TrashIcon,PencilSquareIcon} from "react-native-heroicons/outline";
...
const inputImg=()=>{
  ...
  setImg({attachments:"http://localhost:4300/clientAttachments/attachments_1678770505806.jpg"});
};
  ...
  return (
    ...
    <SafeAreaView>
     ...
     >
        ...
        marginTop:50}}
        >Add Assignment</Text>
        <TextInput placeholder="Assignment Name" 
        style={{
          margin: 12,
          borderWidth: 1,
          padding: 10,
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <PencilSquareIcon style={{color:"black"}}></PencilSquareIcon>
