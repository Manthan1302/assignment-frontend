...
const Login=({history})=> {
    ...
    useLayoutEffect(() => {
      ...
      const signInweb = async()=>{
        ...
        if(logUser.email === "" || logUser.password === "")
        {
            console.log("🚀 ~ file: login.screen.js:118 ~ signInweb ~ logUser", logUser);
            ...
            if(response)
            {
                    ...
                    console.log("🚀 ~ file: login.screen.js:73 ~ signin ~ response", response)
                    setLoader(false);
                    setLogUser({
                        email:"",
                        password:"",
        ...
        return (
            ...
            <SafeAreaView style={{backgroundColor:'#fff',height:'100%'}}>
                ...
                <View>
                    ...
                    <TextInput style={[styles.container , styles.center]} onChangeText={(text)=>setFields(text,"email")}/>
                    <Text>{"\n"}</Text> 
                    <Text style={styles.texts} >Password</Text>
                    <TextInput style={[styles.container , styles.center]} 
                    secureTextEntry={true} onChangeText={(text)=>setFields(text,"password")}/>
                    <Text>{"\n"}</Text> 
                    <View style={styles.center}>
                        ...
                        <View  style={{
                            ...
                            <Text style={{fontSize:17}}>Don't have an account?</Text> 
                             ...
                             <Text style={{fontSize:17,color:"gray"}}>Sign Up now</Text> 
                            </TouchableOpacity> 
                        </View>
        ...
        return (
         ...
         <div style={{display:'flex',backgroundColor:'#4340ab'}} >
                ...
                <br></br>
                    ...
                    <TextInput type="text"  placeholder="Enter email.." style={{height:30,
                        width:250,
                        borderRadius:7}
                        } onChangeText={(text)=>setFields(text,"email")}/><br></br><br></br>
                    <label style={{marginRight:180,color:"#fff"}}>Password</label><br></br>
                    <TextInput type="text"  placeholder="Enter Password.." style={{height:30,
                        width:250,
                        borderRadius:7}} onChangeText={(text)=>setFields(text,"password")}/><br></br><br></br><br></br>
                    <button style={{width:150,height:35,borderRadius:7,backgroundColor:"#fff",color:"000000"}} onPress={()=>signInweb()}>Login</button>
